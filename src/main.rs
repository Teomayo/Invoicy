...
// static ACCOUNT_NAME: String = whoami::username().to_string();
// static DIR_NAME: &str = format!("/Users/{}/Library/Fonts/", ACCOUNT_NAME).as_str();
// static   FONT_DIRS: &[&str] = &[
//     DIR_NAME
// ];
// static  DEFAULT_FONT_NAME: &'static str = "JetBrainsMono";

// const IMAGE_PATH_PNG: &'static str = "images/farbalogo.png";
const MONO_FONT_NAME: &'static str = "JetBrainsMono";
...
fn main() {
    ...
    let font_dirs: &[String] = &[dir_name];
    let default_font_name: &'static str = "JetBrainsMono";
    ...
    doc.push(
        elements::Paragraph::new("Estimate")
